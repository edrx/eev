...
;; «.find-pdf-page-links»		(to "find-pdf-page-links")
...
;; «find-pdf-page-links»  (to ".find-pdf-page-links")
;; Skel: (find-find-links-links-new "pdf-page" "" "")
;; Test: (find-pdf-page-links)
;;
(defun find-pdf-page-links (&rest pos-spec-list)
"Visit a temporary buffer containing hyperlinks for pdf-page."
  (interactive)
  (apply
   'find-elinks-elisp
   `((find-pdf-page-links ,@pos-spec-list)
     ;; Convention: the first sexp always regenerates the buffer.
     (find-efunction 'find-pdf-page-links)
     ""
     ,(ee-template0 "\
;; (find-efunction 'find-pdf-page)
;; (find-ealias    'find-pdf-page)
